package ca.polymtl.log8430.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(ca.polymtl.log8430.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(ca.polymtl.log8430.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
            cm.createCache(ca.polymtl.log8430.domain.User.class.getName(), jcacheConfiguration);
            cm.createCache(ca.polymtl.log8430.domain.Authority.class.getName(), jcacheConfiguration);
